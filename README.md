...
// Package.swift
dependencies: [
    .package(url: "https://github.com/nanbu/SwiftSheets.git", from: "0.16.0")
],
targets: [
...
Status: **0.16.0** — all five formats are usable; the API may still change before 1.0. What changed in each release
