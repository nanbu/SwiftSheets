...
package enum XLSXCodec: SpreadsheetCodec {
    package static var format: SheetFormat { .xlsx }
...
package enum XLSMCodec: SpreadsheetCodec {
    package static var format: SheetFormat { .xlsm }
