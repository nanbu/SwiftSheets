...
@Suite struct CrossFormatConversionTests {
    ...
    static let namedBy: [String: String] = [
        "array formulas": "array formula",
        "outline groups": "grouping",
        "conditional formatting": "conditional format",
        "CF colour scale": "colorScale",
        "CF data bar": "dataBar",
        "CF icon set": "iconSet",
        "data validation": "data validation",
        "structured tables": "named table",
        "auto-filter": "auto-filter",
        "filter criteria": "auto-filter",
        "sort state": "auto-filter",
        "pivot tables": "pivot table",
        "sheet protection": "sheet protection",
        "protected ranges": "protected range",
        "scenarios": "scenario",
        "print header and footer": "print setup",
        "print orientation": "print setup",
        "print area": "print area",
        "print title rows": "title rows",
        "page breaks": "page breaks",
        "tab colour": "tab colour",
        "workbook defined names": "defined name",
        "sheet defined names": "defined name",
        "workbook protection": "workbook protection",
        "custom properties": "custom document propert",
        "hidden sheets": "hidden sheet",
        "cell controls": "cell control",
        "quote functions": "fetches live data",
        "several tables per sheet": "other table(s) not written",
        "label ranges": "label range",
        "consolidation": "consolidation",
        "detective arrows": "tracing arrow",
        "calculation settings": "a calculation setting is dropped",
    ]
